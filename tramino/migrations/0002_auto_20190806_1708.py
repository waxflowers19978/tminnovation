# Generated by Django 2.1 on 2019-08-06 08:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.DeleteModel(
            name='team_infomation',
        ),
        migrations.AddField(
            model_name='pastgamerecords',
            name='register_team_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='past_game_records', to='tramino.TeamInformation'),
        ),
        migrations.AddField(
            model_name='favoriteteampool',
            name='guest_team_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_recipient_team', to='tramino.TeamInformation'),
        ),
        migrations.AddField(
            model_name='favoriteteampool',
            name='host_team_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_sender_team', to='tramino.TeamInformation'),
        ),
        migrations.AddField(
            model_name='favoriteeventpool',
            name='guest_team_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_favorites', to='tramino.TeamInformation'),
        ),
        migrations.AddField(
            model_name='eventpostpool',
            name='event_host_team',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_posts', to='tramino.TeamInformation'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='eventapplypool',
            name='guest_team_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='event_applies', to='tramino.TeamInformation'),
        ),
    ]
